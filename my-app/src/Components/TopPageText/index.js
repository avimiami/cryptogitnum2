...
const TopTextCard = ({ crypto }) => {
  ...
  return (
    <Card className={classes.root}>
      <div>Macro-Economic Risk Signals.</div> 
      <div> Volatility ⛔ Credit spreads ⛔  Foreign Exchange ⚠️. Short term: [vol is 👍], [credit 👎] and [fx is 👍]. Look to buy the dip if vol heads lower.</div> 
    </Card>
  );
};
